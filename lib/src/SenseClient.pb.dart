...
class Request extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Request', package: const $pb.PackageName('sense.full.v1'), createEmptyInstance: create)
...
class RequestStream extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RequestStream', package: const $pb.PackageName('sense.full.v1'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, 'data', $pb.PbFieldType.OY)
    ..aOS(2, 'task')
    ..aOS(3, 'apikey')
    ..aOS(5, 'dtype')
  ...
  factory RequestStream.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RequestStream.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  RequestStream clone() => RequestStream()..mergeFromMessage(this);
  RequestStream copyWith(void Function(RequestStream) updates) => super.copyWith((message) => updates(message as RequestStream));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RequestStream create() => RequestStream._();
  RequestStream createEmptyInstance() => create();
  static $pb.PbList<RequestStream> createRepeated() => $pb.PbList<RequestStream>();
  @$core.pragma('dart2js:noInline')
  static RequestStream getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RequestStream>(create);
  ...
  @$pb.TagNumber(5)
  set dtype($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set sr($core.int v) { $_setSignedInt32(4, v); }
  @$pb.TagNumber(6)
...
class Response extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Response', package: const $pb.PackageName('sense.full.v1'), createEmptyInstance: create)
    ..aOS(7, 'outputs')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  set outputs($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(7)
